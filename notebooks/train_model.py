...
# Elle montre les erreurs précises du modèle (ce qu'il confond)
...
# Sauvegarder la figure pour votre rapport
...
# Cela crée un fichier 'model.pkl' que vous pourrez réutiliser plus tard
